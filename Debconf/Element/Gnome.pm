...
This is needed because Gtk3::MessageDialog has a much
worse behavior than the other Gtk3:: perl widgets when
it comes to an UTF-8 locale.

(This was originally written for Gtk2; is it still true for Gtk3?)
